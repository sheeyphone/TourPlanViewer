export default [
  ...
  { id: 'd5', day: 12, mode: 'drive', from: 'harstad', to: 'tromso', ferry: false, status: 'todo', km: 273, via: [[16.591, 68.7769], [16.8513, 68.7264]], overview: 'full', geometryFile: 'd5.geojson', note: 'Harstad → Stangnes 渡轮 → Sørrollnes → Tromsø（约255km路 + 40min渡轮）' },
