...
> Keep in sync with `app/src/data/itinerary.js`. Flights / hotels are kept in the private `app/public/trip.json` (not in the repo).

## Day 1 · 09-26 (Sat) Shenzhen → Hong Kong → Bangkok
- Overnight transit at Bangkok airport (flight / hotel: see private data)

## Day 2 · 09-27 (Sun) Bangkok → Helsinki · evening
- Senate Square + Cathedral (daylight golden hour + lit night), Uspenski exterior (dusk), Central Station, Esplanadi, SkyWheel / harbour sunset, dinner
- Sunset ~19:05 (airport transport / hotel: private data)

## Day 3 · 09-28 (Mon) Helsinki morning → Oslo afternoon
- Old Market Hall breakfast, Rock Church (10:00), Oodi, coffee → Oslo Opera roof / Vigeland / Akershus walls
- Monday-closed museums skipped (flight / hotel: private data)

## Day 4 · 09-29 (Tue) Oslo · full day (The Scream)
- Nasjonalmuseet The Scream (1893), City Hall, optional Fram / Kon-Tiki, Holmenkollen
...
## Day 14 · 10-09 (Fri) Bangkok → Hong Kong → Shenzhen
- Arrive HKG ~11:35 (flight: private data)
